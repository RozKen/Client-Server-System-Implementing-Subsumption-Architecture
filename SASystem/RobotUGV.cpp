...
RobotUGV::RobotUGV(std::string directoryPath, std::string fileName)
...
void RobotUGV::Initialize(){
	...
	this->nearest = new std::vector<RobotUGV *>();
...
void RobotUGV::Update(){
	updateInnerGeoMap();
	updateInnerRadMap();
	updateInnerSemMap();
}

float RobotUGV::getDX() const {
	return this->getOutput(2);
}

float RobotUGV::getDY() const {
	return this->getOutput(3);
}

float RobotUGV::getBattery() const{
	return this->getInput(0);
}
void RobotUGV::setBattery(float value){
	this->setInput(0, value);
}
float RobotUGV::getPosX() const{
	return this->getInput(1);
}
void  RobotUGV::setPosX(float value){
	this->setInput(1, value);
}
float RobotUGV::getPosY() const{
	return this->getInput(2);
}
void RobotUGV::setPosY(float value){
	this->setInput(2, value);
}

float RobotUGV::getDirection() const{
	return this->getInput(3);
}
void RobotUGV::setDirection(float value){
	this->setInput(3, value);
}

float RobotUGV::getRange(int index) const{
	return this->getInput(4 + index);
}

void RobotUGV::setRange(int index, float value){
	this->setInput(4 + index, value);
}

float RobotUGV::getRad(int index) const{
	return this->getInput(4 + RANGE_DIV + index);
}

void RobotUGV::setRad(int index, float value){
	this->setInput(4 + RANGE_DIV + index, value);
}

int RobotUGV::getBatteryCharger() const{
	return this->getInput(4 + RANGE_DIV + MAX_AREA);
}

void RobotUGV::setBatteryCharger(float value){
	this->setInput(4 + RANGE_DIV + MAX_AREA, value);
}

RobotUGV* RobotUGV::getRelativeRoot(){
	return this->relativeRoot;
}

void RobotUGV::setRelativeRoot(RobotUGV* root){
	this->relativeRoot = root;
}

int RobotUGV::getHop() const{
	return this->getOutput(1);
}

void RobotUGV::setHop(int hop){
	this->setInput(53, hop);
}

float RobotUGV::getRobot(int index, bool x){
	int odd = 1;
	if(x){
		odd = 0;
	}
...
void RobotUGV::setRobot(int index, float value, bool x){
	int odd = 1;
	if(x){
		odd = 0;
	}
...
float RobotUGV::getColorR() const{
	return this->color[0];
}
float RobotUGV::getColorG() const{
	return this->color[1];
}
float RobotUGV::getColorB() const{
	return this->color[2];
}

float RobotUGV::getObjectiveX() const{
	return this->cE->getDestinationX();
}

float RobotUGV::getObjectiveY() const{
	return this->cE->getDestinationY();
}


void RobotUGV::ProcessArbiters(){
...
void RobotUGV::updateInnerGeoMap(){
	//Self Acquired Data
...
void RobotUGV::updateInnerRadMap(){
	//Self Acquired Data
...
void RobotUGV::updateInnerSemMap(){
	//Self Acquired Data
	int x = this->getPosX();
	int y = this->getPosY();
...
SenseNet* RobotUGV::getSenseNet(){
	///現在はSenseNetのModuleはindex == 3のところで登録されている．
	///もし，Moduleを登録する順番に変更があれば，ここも変更する必要がある．
	return (SenseNet*)(this->modules->at(3));
}

void RobotUGV::pushNearest(RobotUGV * robot){
	this->nearest->push_back(robot);
	numOfNearestRobots = nearest->size();
}

RobotUGV* RobotUGV::getNearestAt(int index){
	return this->nearest->at(index);
}

std::vector<RobotUGV *>* RobotUGV::getNearest(){
	return this->nearest;
}

void RobotUGV::clearNearest(){
	this->nearest->clear();
	numOfNearestRobots = 0;
}

int RobotUGV::getNumOfNearestRobots() const{
