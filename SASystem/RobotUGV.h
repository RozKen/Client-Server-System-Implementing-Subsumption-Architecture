#ifndef _Robot_UGV_H_
#define _Robot_UGV_H_
...
public:
	 ...
	 */
	RobotUGV();
	RobotUGV(std::string directoryPath, std::string fileName);
	...
	/**
		...
		@sa World::updateBatteryCharger(RobotUGV* robot)
	 */
